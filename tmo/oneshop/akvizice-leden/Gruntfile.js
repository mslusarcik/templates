module.exports = function (grunt) {
  ...
  grunt.initConfig({
    purgecss: {
      my_target: {
        ...
        files: {
          'assets/css/main-ready.css': ['assets/css/main.css']
        }
      }
    },
    sass: {
      ...
      dist: {
        files: {
          "assets/css/temp/main-ready.css": "assets/scss/main.scss",
        },
      },
    },
    cssmin: {
    ...
    autoprefixer: {
      ...
      dist: {
        // Target
        files: {
          "assets/css/main.css": "assets/css/temp/main-ready.css",
        },
      },
    },
    imagemin: {
  ...
  grunt.registerTask("css", ["sass", "autoprefixer", "postcss"]);
  grunt.registerTask("public", ["copy"]);
  grunt.registerTask("default", ["connect", "watch"]);
  grunt.registerTask('clean', ['sass', 'postcss']);
